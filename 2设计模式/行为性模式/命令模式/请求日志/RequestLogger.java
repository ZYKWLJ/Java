...
class FileUtil {
    ...
    public static void writeCommands(ArrayList commands) {
        try {
            FileOutputStream file = new FileOutputStream("D:\\设计模式\\CreatePattern\\src\\main\\resources\\行为型模式\\CommandPattern\\config.log");
            //创建对象输出流用于将对象写入到文件中
    ...
    public static ArrayList readCommands() {
        try {
            FileInputStream file = new FileInputStream("D:\\设计模式\\CreatePattern\\src\\main\\resources\\行为型模式\\CommandPattern\\config.log");
            //创建对象输入流用于从文件中读取对象
