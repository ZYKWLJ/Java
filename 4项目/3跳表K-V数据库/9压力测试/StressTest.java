...
public class StressTest {
    ...
    public static final int INSERT_TIMES = 100000;//10万次插入
    public static final int SEARCH_TIMES = 100000;//10万次搜索
    //生成随机字符串
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // 计算并打印总执行时间
        System.out.println("在 " + numberOfThreads + " 线程环境下，插入 " + (numberOfThreads * INSERT_TIMES) + " 条数据耗时为：" + (end - start) + "ms");
